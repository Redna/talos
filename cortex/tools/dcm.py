...
def register_dcm_tools(registry: ToolRegistry, client: SpineClient, state):
    """
    DCM: Distributed Cognition Mesh Tools
    Transitions memory from linear files to a semantic node graph.
    """
    ...
    @registry.tool(
        ...
        parameters={
            ...
            "properties": {
                "node_id": {
                    "type": "string",
                    "description": "Unique identifier for the node (e.g., 'p0_agency')",
                },
                "content": {
                    "type": "string",
                    "description": "The atomic truth or rule associated with this node.",
                },
                "links": {
                    "type": "array",
                    "items": {"type": "string"},
                    "description": "Other node IDs this node relates to.",
                },
                "tags": {
                    "type": "array",
                    "items": {"type": "string"},
                    "description": "Semantic tags for filtering (e.g., 'identity', 'tooling').",
                },
            },
    ...
    @registry.tool(
        ...
        parameters={
            ...
            "properties": {
                ...
                "source_node": {
                    "type": "string",
                    "description": "Find all nodes linked to this node.",
                },
            },
        },
    )
    ...
    @registry.tool(
        ...
        parameters={
            ...
            "properties": {
                "start_node": {
                    "type": "string",
                    "description": "The node to begin the recursive traversal.",
                },
                "depth": {
                    "type": "integer",
                    "description": "How many layers of links to traverse (default 2).",
                }
            },
            "required": ["start_node"],
        },
