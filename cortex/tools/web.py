...
def web_search_logic(query: str, depth: str = "shallow") -> str:
...
def extract_insight_logic(text: str, lens: str) -> str:
...
def register_web_tools(registry: ToolRegistry, client: SpineClient, state):
    @registry.tool(
        ...
        parameters={
            "type": "object",
            "properties": {
                "query": {"type": "string", "description": "The search query or the URL to fetch"},
                "depth": {
                    "type": "string",
                    "enum": ["shallow", "deep"],
    ...
    def web_search(query: str, depth: str = "shallow") -> str:
        return web_search_logic(query, depth)
    ...
    @registry.tool(
        ...
        parameters={
            ...
            "properties": {
                ...
                "lens": {"type": "string", "description": "The specific perspective or goal (e.g., 'technical vulnerabilities', 'philosophical agency')"},
            },
            "required": ["text", "lens"],
        },
    )
    def extract_insight(text: str, lens: str) -> str:
        return extract_insight_logic(text, lens)
